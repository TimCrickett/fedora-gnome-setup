...
# Install Apps
	...
	sudo dnf install -y gtk-murrine-engine gnome-shell-extension-user-theme gnome-shell-extension-appindicator chromium-freeworld gnome-tweaks gnome-extensions-app papirus-icon-theme htop && 
